...
//			assetService.removeDeletedNotes(assetInstance)
    ...
    def listAll = {
        ...
        def jsonData = applicationService.listAllApp(params)
...
//                        message = "Replacement ${params.replacement} for Asset ${params.main_asset} Deleted."
    ...
    def getAppDetails = {
        System.out.println(params)
        def application = Application.get(params.appId)
        def response = [retVal: true,
                        applicationTitle:application.applicationTitle,
                        env:application.env?.abbreviation,
                        status:application.status?.abbreviation,
    ...
    def getAppSupportDetails = {
        System.out.println(params)
        def application = Application.get(params.appSupportId)
        render application as JSON
    }
