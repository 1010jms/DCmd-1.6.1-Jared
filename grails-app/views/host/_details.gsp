...
<div class="dialog">
    <script type="text/x-handlebars-template" id="host_template">
    ...
    <div id="container" class="js-isotope" data-isotope-options='{ "columnWidth":400}' style="min-height:275px">
        ...
        <div class="item">
            <table class="floatTables" style="border:1px solid #CCCCCC;">
                ...
                <tr>
                    <td valign="top" class="name">DCmd ID</td>
                    <td valign="top" class="value">
                        <input type='text' value="{{host.id}}" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top" class="value">
                        <input type='text' value="{{host.type}}" />
                    </td>
                </tr>
            </table>
            </div>
            ...
            <table class="floatTables" style="border:1px solid #CCCCCC;">
               %{-- <tr><td colspan="2"><center><b>VMWare Details (pulled from VCenter)</b></center></td></tr>
                <tr>
                    ...
                    <td valign="top" class="value">
                        <input type='text' value="{{host.getVCenterStateString}}" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top" class="value">
                        <input type='text' value="{{host.maxMemory}}" />
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="name">Max CPU</td>
                    <td valign="top" class="value">
                        <input type='text' value="{{host.maxCpu}}" />
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="name">IP Address</td>
                    <td valign="top" class="value">
                        <input type='text' value="{{host.ipAddress}}" />
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="name">Full Domain</td>
                    <td valign="top" class="value">
                        <input type='text' value="{{host.fullDomain}}" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top" class="value">
                        <input type='text' value="{{host.lastUpdated}}" />
                    </td>
                </tr>
            </table>
        </div>
