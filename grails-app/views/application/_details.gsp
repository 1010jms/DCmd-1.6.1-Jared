...
<div class="dialog">
    <script type="text/x-handlebars-template" id="app_template">
            ...
            <table class="floatTables" style="border:1px solid #CCCCCC;">
                ...
                <tr>
                    ...
                    <td valign="top" class="value">
                        <input type='text' value="{{application.applicationTitle}}" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top" class="value">
                        <input type='text' value="{{application.applicationDescription}}" />
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="name">Date Created</td>
                    <td valign="top" class="value">
                        <input type='text' value="{{application.dateCreated}}" />
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="name">Last Updated</td>
                    <td valign="top" class="value">
                        <input type='text' value="{{application.lastUpdated}}" />
                    </td>
                </tr>
            </table>
        </div>
