...
<html>
 ...
 <div class="pageBody" id="outerElement">
     ...
     %{--<g:render template="supportListAttributes" />--}%
     <g:render template="supportListGrid" />

     <g:render template="details"/>

     %{--<div id="app_support_dialog" title="Application Support Details">
         <div id="app_support_attributes"></div>
         <g:render template="support-tabs"/>
     </div>--}%
 </div>
