...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        jQuery("#allPerson").jqGrid({
            ...
            colModel:[
                {name:'uhName', editable:false, title:false},
                {name:'lastName', editable:false, title:false},
                {name:'firstName', editable:false, title:false},
        ...
        createTopToolbar("#allPerson");

        jQuery('#allPerson').filterToolbar({id:'allPerson', searchOnEnter:true});
        jQuery('#allPerson').jqGrid('setFrozenColumns');
