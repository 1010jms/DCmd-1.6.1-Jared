...
<table class="floatTables" style="border:1px solid #CCCCCC;">
    ...
    <tr><td colspan="2"><center><b>**Read Only - Pulled from openDCIM**</b></center></td></tr>
    <tr>
        <td valign="top" class="name">RU (Rack Unit) Size</td>
        <td valign="top" class="value">
            <input type='text' value="{{server.RU_size}}" />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td valign="top"class="value">
            <input type='text' value="{{server.position}}" />
        </td>
    </tr>
